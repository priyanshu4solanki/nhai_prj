...
const LivenessScreen: React.FC<LivenessScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={[styles.container, globalStyles.centerContainer]}>
      <Text style={styles.title}>{STRINGS.liveness.title}</Text>
      <Text style={styles.subtitle}>{STRINGS.liveness.subtitle}</Text>
      ...
      <View style={styles.statusContainer}>
        <Text style={styles.statusText}>{STRINGS.liveness.detecting}</Text>
      </View>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>Continue to Recognition</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
};
